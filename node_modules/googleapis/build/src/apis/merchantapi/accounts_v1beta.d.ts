...
export declare namespace merchantapi_accounts_v1beta {
    ...
    export class Resource$Accounts {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getDeveloperRegistration(params: Params$Resource$Accounts$Getdeveloperregistration, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getDeveloperRegistration(params?: Params$Resource$Accounts$Getdeveloperregistration, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DeveloperRegistration>>;
        getDeveloperRegistration(params: Params$Resource$Accounts$Getdeveloperregistration, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getDeveloperRegistration(params: Params$Resource$Accounts$Getdeveloperregistration, options: MethodOptions | BodyResponseCallback<Schema$DeveloperRegistration>, callback: BodyResponseCallback<Schema$DeveloperRegistration>): void;
        getDeveloperRegistration(params: Params$Resource$Accounts$Getdeveloperregistration, callback: BodyResponseCallback<Schema$DeveloperRegistration>): void;
    ...
    export interface Params$Resource$Accounts$Getdeveloperregistration extends StandardParameters {
        /**
         * Required. The `name` (ID) of the developer registration.
         */
        name?: string;
